...
Zissou1Continuous = c("#3A9AB2", "#6FB2C1", "#91BAB6", "#A5C2A3", "#BDC881", "#DCCB4E", "#E3B710", "#E79805", "#EC7A05", "#EF5703", "#F11B00") #wesanderson
  ...
  #26-colors (Polychrome::alphabet.colors)
  alphabet = c("1"="#F6222E","2"="#FE00FA","3"="#16FF32","4"="#3283FE","5"="#FEAF16","6"="#B00068","7"="#1CFFCE","8"="#90AD1C",
               "9"="#2ED9FF","10"="#DEA0FD","11"="#AA0DFE","12"="#F8A19F","13"="#325A9B","14"="#C4451C","15"="#1C8356","16"="#85660D",
               "17"="#B10DA1","18"="#FBE426","19"="#1CBE4F","20"="#FA0087","21"="#FC1CBF","22"="#F7E1A0","23"="#C075A6","24"="#782AB6",
               "25"="#565656","26"="#E2E2E2")
